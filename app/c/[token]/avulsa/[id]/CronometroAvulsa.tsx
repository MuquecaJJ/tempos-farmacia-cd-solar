...
async function adquirirWakeLock(ref: React.MutableRefObject<WakeLockSentinel | null>) {
  try {
...
function liberarWakeLock(ref: React.MutableRefObject<WakeLockSentinel | null>) {
